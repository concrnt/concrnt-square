...
{{<figure src="/images/comparing/push101.png" target="_blank" >}}
...
{{<figure src="/images/comparing/pushcons.png" target="_blank" >}}

---

一方Concrntはプル型のプロトコルであり、ユーザーがタイムラインを**読む際**に、そのサーバーががほかのサーバーからデータを取得します。

{{<figure src="/images/comparing/pull101.png" target="_blank" >}}
...
{{<figure src="/images/comparing/ccrealtime.png" target="_blank" >}}
...
{{<figure src="/images/comparing/apmigrate.png" target="_blank" >}}
...
{{<figure src="/images/comparing/ccid101.png" target="_blank" >}}

このIDは長く、人間が覚えるのは難しいという問題がありますが、これによってサーバーを引っ越してもIDが変わらず、またフォロー関係・投稿・リアクションなどすべてがそのまま引っ越し可能になります。


{{<figure src="/images/comparing/ccmigrate.png" target="_blank" >}}
...
{{<figure src="/images/comparing/atproto101.png" target="_blank" >}}
...
{{<figure src="/images/comparing/bluesky101.png" target="_blank" >}}
...
{{<figure src="/images/comparing/blueskyban.png" target="_blank" >}}

---

ConcrntはBlueskyとは構成が異なり、全てのサーバーが対等な関係を持っています。

{{<figure src="/images/comparing/stillalive.png" target="_blank" >}}
...
{{<figure src="/images/comparing/nostr101.png" target="_blank" >}}
