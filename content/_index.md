...
近年の情報化社会では、「ここに行けばこの人の最新の情報が見れる」というような「ホーム」が必要不可欠でしょう。突然消去されたりしない、安全なホームが。
...
#### いわゆる個人が「情報発信を行うためのツール」であるソーシャルメディアになること
...
Blueskyはdid:plcという(一時的に)中央集権的な解決専用のサービスを作成ており、それを利用しています。
